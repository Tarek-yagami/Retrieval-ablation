...
- Retrieval ablation across five fixed configs (sparse / dense / hybrid / hybrid+rerank / dense+rerank) on two BEIR benchmarks (SciFact, FiQA), scored with IR metrics (nDCG@10, Recall@100, MRR@10) via `ranx`.
